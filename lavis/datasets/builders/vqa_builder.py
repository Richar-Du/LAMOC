...
from lavis.datasets.datasets.aok_vqa_choice_datasets import AOKVQAChoiceDataset, AOKVQAChoiceEvalDataset
...
@registry.register_builder("ok_vqa_policy")
class OKVQAPolicyBuilder(COCOVQABuilder):
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/okvqa/policy.yaml",
    }
...
@registry.register_builder('aok_vqa_choice')
class AOKVQAChoiceBuilder(BaseDatasetBuilder):
    train_dataset_cls = AOKVQAChoiceDataset
    eval_dataset_cls = AOKVQAChoiceEvalDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/aokvqa/choice.yaml"}

@registry.register_builder('aok_vqa_policy')
class AOKVQAPoliyBuilder(BaseDatasetBuilder):
    train_dataset_cls = AOKVQADataset
    eval_dataset_cls = AOKVQAEvalDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/aokvqa/policy.yaml"}
