...
from lavis.datasets.datasets.aok_vqa_caption_datasets import AOKVQACapDataset, AOKVQACapEvalDataset
...
@registry.register_builder("aokvqa_caption")
class AOKVQACapBuilder(BaseDatasetBuilder):
    train_dataset_cls = AOKVQACapDataset
    eval_dataset_cls = AOKVQACapEvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/aokvqa/caption.yaml",
    }